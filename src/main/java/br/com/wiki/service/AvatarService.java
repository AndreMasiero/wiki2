...
import br.com.wiki.repository.AvatarRepository;

@Service
@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
public class AvatarService {

	public final Logger LOG = Logger.getLogger(AvatarService.class);
	...
	public Avatar getAvatarByUpload(MultipartFile file) {
		...
		if (file != null && file.getSize() > 0) {
			try {
				...
				LOG.error("A um erro na classe AvatarService " + e.getMessage());
			}
