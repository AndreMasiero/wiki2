...
import br.com.wiki.entity.Perfil;
import br.com.wiki.entity.Usuario;
import br.com.wiki.service.AvatarService;
import br.com.wiki.service.UsuarioService;
import br.com.wiki.util.TextosTela;
import br.com.wiki.web.editor.PerfilEditorSupport;
import br.com.wiki.web.validator.UsuarioValidator;
...
public class UsuarioController {
	...
	public ModelAndView pageUsuario(@PathVariable("page") Integer pagina, @PathVariable("order") String order,
	...
	public ModelAndView showForm(@ModelAttribute("usuario") Usuario usuario) {
		ModelAndView view = new ModelAndView();
		view.addObject("titulo", textoTela.titulo());
		view.setViewName("usuario/cadastro");
		return view;
	}
