...
public class ExceptionController {
	...
	public ModelAndView httpRequestMethodNotSupportedException(HttpServletRequest req, HttpRequestMethodNotSupportedException ex) {
		
		ModelAndView view = new ModelAndView("error");
		view.addObject("mensagem", "Request method 'GET' not supported.");
		view.addObject("url", req.getRequestURL());
		view.addObject("excecao", ex);
